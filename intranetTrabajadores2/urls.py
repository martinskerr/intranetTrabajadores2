...
urlpatterns = [
    ...
    path('post_login_redirect/', post_login_redirect, name='post_login_redirect'),
    path('vistaAdmin/', home_admin, name='vistaAdmin'),
    path('vistaUser/', home_user, name='vistaUser' ),
